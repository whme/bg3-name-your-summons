...
The release `.zip` is signed with a [GitHub build
...
`whme/bg3-name-your-summons` release workflow at the tagged commit - i.e.
the `.zip` you have is byte-for-byte the one GitHub built for this release
and was not modified or repackaged after upload.
